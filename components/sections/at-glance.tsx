...
const CYLINDER_R = 300       // circumradius — controls card spacing around the orbit

const DIAMOND_W = 240
const DIAMOND_H = 320

// Diamond center (cylinder axis) — roughly 40% down the section
const DIAMOND_CX = 720
const DIAMOND_CY = 372

// perspective:90vw from live site CSS
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Diamond — counter-rotated so it stays stationary */}
          <div
            style={{
              position: 'absolute',
              left: -DIAMOND_W / 2,
...
export function AtGlance() {
  return (
    ...
    >
      ...
      >
        We&rsquo;ve been around the block
      </p>
      ...
      {/* Gem — left, width:120px per live site CSS */}
      <div className="absolute pointer-events-none" style={{ left: 300, bottom: '15.5%', width: 120, zIndex: 50 }}>
        <Image src="/assets/gem-3d.svg" alt="" width={120} height={161} className="object-contain" unoptimized />
      </div>

      {/* Hexagon — right, width:120px per live site CSS */}
      <div className="absolute pointer-events-none" style={{ right: '18%', bottom: '15.5%', width: 120, zIndex: 50 }}>
        <Image src="/assets/hexagon-3d.svg" alt="" width={120} height={130} className="object-contain" unoptimized />
      </div>
    </section>
  )
}
